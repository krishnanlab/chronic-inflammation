...
# for args[2]
neighbors_path = "/mnt/scratch/hickeys6/biogrid_hotnet2_permutations/biogrid_hotnet2_permutations_noRWR/node_neighborhood_lists"
# path to permuted edgelists
# for args[3]
edgelist_path = "/mnt/scratch/hickeys6/biogrid_hotnet2_permutations/biogrid_hotnet2_permutations_noRWR/edgelists"
# results path for args[9]
results_path = "/mnt/scratch/hickeys6/biogrid_hotnet2_permutations/biogrid_hotnet2_permutations_noRWR"
...
for(i in first_perm:last_perm) {
    ...
    writeLines(c("#!/bin/sh -login",
                 ...
                 "Rmodules",
                 "",
                 paste0("Rscript expandAndCluster_permuted.R ",
                        dg_path,
                        " ",
                        neighbors_path,
                        "/biogrid_permutation",
