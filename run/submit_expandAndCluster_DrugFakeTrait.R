...
#for args[1]
dg_path = "/mnt/research/compbio/krishnanlab/projects/chronic_inflammation/data/disease_gene_files/faketraits"
setwd(dg_path)
...
results_path = "/mnt/scratch/hickeys6/biogrid_hotnet2_permutations/drug_faketrait_networks"
# set pval cutoff
cutoff = 0.01
# use FDR?
FDR_logical = FALSE
